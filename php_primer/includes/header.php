...
<body>
    ...
    <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a class="nav-link" href="whiledowhile.php">Simple Do While</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="stingmanip.php">Simple String Manipulation</a></li>
